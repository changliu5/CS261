...
int main(int argc, char* argv[]){
    ...
    assertTrue(EQ(getDynArr(dyn, 0),6), "Test the 1st element is 6");
    assertTrue(EQ(getDynArr(dyn, 1),5), "Test the 2nd element is 5");
    assertTrue(EQ(getDynArr(dyn, 2),9), "Test the 3rd element is 9");
    assertTrue(sizeDynArr(dyn) == 3, "Test size = 3");
